...
export function createExpense(data) {
  ...
  const result = db.prepare(`
    INSERT INTO expenses (concept_id, concept_name, category, amount_cents, month, due_date, notes)
    VALUES (@conceptId, @name, @category, @amountCents, @month, @dueDate, @notes)
...
export function generateMonth(month) {
  ...
  const insert = db.prepare(`
    INSERT OR IGNORE INTO expenses
      (concept_id, concept_name, category, amount_cents, month, due_date)
    VALUES (?, ?, ?, ?, ?, ?)
  `);
